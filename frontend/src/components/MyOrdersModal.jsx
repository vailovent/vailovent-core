      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-2xl w-full max-h-[85vh] flex flex-col border border-gray-100 transform transition-all animate-scaleUp overflow-hidden my-auto">
        ...
        <div className="px-4 sm:px-5 pt-3">
          <div className="flex items-start gap-2 px-3.5 py-2.5 bg-amber-50 border border-amber-200 rounded-xl text-xs text-amber-800">
            ...
            <span>
              Riwayat pesanan tersimpan di <strong>browser perangkat ini saja</strong> dan dapat hilang jika data browser dihapus. Simpan <strong>Order ID</strong> atau cek <strong>email</strong> Anda sebagai cadangan.
            </span>
          </div>
        </div>
